...
namespace GameOfLife
{
    public class Drawer
    {
        ...
        public void DrawCells(int width, int height, Cell[,] cells)
        {
            ...
            Dictionary<byte, List<Rectangle>> stateGroups = new Dictionary<byte, List<Rectangle>>();
            foreach (KeyValuePair<byte, CellState> pair in Storage.Game.CellStates)
            {
            ...
            foreach (KeyValuePair<byte, List<Rectangle>> pair in stateGroups)
            {
